...
[{ if $oConfig->getConfigParam("sJxExtAdminShowArticlePictures") }]
    <colgroup>
        <col width="1%" nowrap>
        <col width="1%" nowrap>
        <col width="1%" nowrap>
    ...
    <tr>
      ...
      <td nowrap="nowrap">
          ...
          <a href="Javascript:if (confirm('[{ oxmultilang ident="JXEXTADMIN_PICTURES_DELETECONFIRM" }]')==true) DeletePic('TH');" class="deleteText"><span class="ico"></span><span class="float: left;>">[{ oxmultilang ident="GENERAL_DELETE" }]</span></a>
          [{/if}]
      </td>
    </tr>
    ...
    <tr>
      ...
      <td nowrap="nowrap">
          ...
          <a href="Javascript:if (confirm('[{ oxmultilang ident="JXEXTADMIN_PICTURES_DELETECONFIRM" }]')==true) DeletePic('ICO');" class="deleteText"><span class="ico"></span><span class="float: left;>">[{ oxmultilang ident="GENERAL_DELETE" }]</span></a>
          [{/if}]
      </td>
    </tr>
[{ else }]
