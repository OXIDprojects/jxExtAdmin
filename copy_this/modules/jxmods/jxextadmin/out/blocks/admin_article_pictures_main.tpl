   ...
   [{/if}]
    ...
    <tr>
      ...
      <td nowrap="nowrap">
          ...
          <a href="Javascript:if (confirm('[{ oxmultilang ident="JXEXTADMIN_PICTURES_DELETECONFIRM" }]')==true) DeletePic('[{$iIndex}];');" class="deleteText"><span class="ico"></span><span class="float: left;>">[{ oxmultilang ident="GENERAL_DELETE" }]</span></a>
          [{/if}]
      </td>
      <td>
          ...
          [{if $blPicUplodaded && !$readonly }]
               ...
               <a href="[{$sPicUrl}]" class="zoomText" target="_blank"><span class="ico"></span><span class="float: left;>">[{ oxmultilang ident="JXEXTADMIN_PICTURES_OPENPREVIEW" }]</span></a>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
