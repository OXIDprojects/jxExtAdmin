...
[{*  ------------------------------------------
  ...
  *      admin_article_variant_listheader 
  *  in file 
  *      article_variant.tpl 
  *
...
[{ if $oConfig->getConfigParam("sJxExtAdminShowArticleVariant") }]
    ...
    <td class="listheader">[{ oxmultilang ident="GENERAL_AJAX_SORT_OXMPN" }]</td>
    <td class="listheader">[{ oxmultilang ident="JXEXTADMIN_BPRICE" }]</td>
    <td class="listheader">[{ oxmultilang ident="JXEXTADMIN_PRICE" }]</td>
    <td class="listheader">[{ oxmultilang ident="JXEXTADMIN_TPRICE" }]</td>
